...
func (l *AddPermissionLogic) AddPermission(req *types.CreatePermissionReq) (resp *types.RespEmpty, err error) {
	...
	_, err = policyModel.Insert(l.ctx, &db.Policy{
	...
	audit.NewAdminAudit(user.Id, "管理员新增权限（%s）成功", req.Name)
