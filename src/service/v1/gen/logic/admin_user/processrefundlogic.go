...
func (l *ProcessRefundLogic) ProcessRefund(req *types.AdminProcessRefundReq) (resp *types.RespEmpty, err error) {
	...
	if req.Success {
		err = selfpay.Refund(l.ctx, srcUser, pay)
	...
	audit.NewAdminAudit(user.Id, "管理员处理退款（%s）", pay.PayId)
