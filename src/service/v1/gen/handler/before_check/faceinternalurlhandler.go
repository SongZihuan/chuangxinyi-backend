...
func FaceInternalUrlHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		l := before_check.NewFaceInternalUrlLogic(r.Context(), svcCtx)
		err := l.FaceInternalUrl(&req, w, r)
		if err != nil {
